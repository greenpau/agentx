...
**PLAT-034 — Lock discipline.** Lock files carry owner and freshness evidence appropriate to the domain. Acquisition is exclusive or verified after write; release is owner-aware and idempotent. Stale thresholds are explicit. Corrupt locks fail safe or follow a documented recovery path.

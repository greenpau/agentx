...
module SourceInventory
  ...
  EXACT_OWNER = {
    ...
    'pkg/config/config.go' => 'implementation-startup-settings',
    'pkg/config/envfile.go' => 'implementation-auth-network',
    'pkg/config/envfile_links_other.go' => 'implementation-auth-network',
    'pkg/config/envfile_links_unix.go' => 'implementation-auth-network',
    'pkg/config/envfile_links_windows.go' => 'implementation-auth-network',
    'pkg/config/envfile_open_other.go' => 'implementation-auth-network',
    'pkg/config/envfile_open_unix.go' => 'implementation-auth-network',
    'pkg/config/envfile_permissions_other.go' => 'implementation-auth-network',
    'pkg/config/envfile_permissions_unix.go' => 'implementation-auth-network',
    'pkg/config/envfile_permissions_windows.go' => 'implementation-auth-network',
